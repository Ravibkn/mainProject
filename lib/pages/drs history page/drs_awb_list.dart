// ignore_for_file: prefer_const_constructors, sort_child_properties_last, prefer_const_literals_to_create_immutables, use_build_context_synchronously, override_on_non_overriding_member, non_constant_identifier_names, avoid_print, unused_local_variable, unnecessary_brace_in_string_interps
...
class _DrsAwbHistoryState extends State<DrsAwbHistory> {
  ...
  Widget getCard(item) {
    ...
    var status = item['delivered'];

    return InkWell(
      onTap: () {
        Navigator.pushNamed(context, MyRouts.drsDetallHistoryRout, arguments: {
          "drs_id": drs_id,
          "m_id": m_id,
          "shipment_id": slipNo,
          "listType": "List"
